...
--Solution
-- I can see two answers for this or two ways of interpreting with DISTINCT and without DISTINCT 
...
-- I am making an assumtion as to the entry with the highest market_date for a given product_id represents the "last" quantity. 
